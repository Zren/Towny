...
public class NationInvite extends Invite {
	...
	public NationInvite(String inviteeName, String invitorName, TownyUniverse universe, String nationName) {
		super(inviteeName);
	...
	public void accept() throws InviteException {
		try {
			...
			if (!town.isMayor(invitee))
				throw new InviteException("You no longer has permission to accept this task.");
